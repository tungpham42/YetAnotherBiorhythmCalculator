...
<section id="stats" class="context-menu-'.$this->_diff.'-'.$this->_is_secondary.'-'.$this->_partner_dob.'-'.$this->_lang_code.'">
	...
	<div class="helper changeable"><i class="icon-circle-question-mark icon-white"></i></div>
	<p><center><a id="go_to_chart" href="javascript:void(0);"><i class="icon-stats x3"></i></a><a id="wiki_user" target="_blank" href="'.get_wiki_url(($fullname != "" ? $fullname : $dob)).'"><i class="social-wikipedia x3"></i></a></center></p>
