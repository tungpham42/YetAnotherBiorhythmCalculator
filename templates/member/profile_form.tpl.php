...
?>
<form id="profile_form" method="POST" action="/member/<?php echo load_member()['email']; ?>/">
	<div class="m-input-prepend top-left-corner top-right-corner bottom-left-corner bottom-right-corner">
		...
		<input class="m-wrap translate disabled top-right-corner bottom-right-corner" size="20" type="text" data-lang-ja="<?php echo $input_interfaces['email']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['email']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['email']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['email']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['email']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['email']['vi']; ?>" placeholder="<?php echo $input_interfaces['email'][$lang_code]; ?>" value="<?php echo $inputted_email; ?>" disabled>
	</div>
	<div class="m-input-prepend top-left-corner top-right-corner bottom-left-corner bottom-right-corner">
		<span class="add-on top-left-corner bottom-left-corner"><?php echo translate_span('fullname'); ?></span>
		<input class="m-wrap translate required top-right-corner bottom-right-corner" size="20" type="text" name="member_profile_fullname" data-lang-ja="<?php echo $input_interfaces['fullname']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['fullname']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['fullname']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['fullname']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['fullname']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['fullname']['vi']; ?>" placeholder="<?php echo $input_interfaces['fullname'][$lang_code]; ?>" value="<?php echo $inputted_fullname; ?>" required>
	</div>
	<div class="m-input-prepend top-left-corner top-right-corner bottom-left-corner bottom-right-corner">
		<span class="add-on top-left-corner bottom-left-corner"><?php echo translate_span('dob'); ?></span>
		<input id="member_profile_dob" class="m-wrap required top-right-corner bottom-right-corner" size="20" type="text" name="member_profile_dob" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-MM-DD" value="<?php echo $inputted_dob; ?>" required>
	</div>
<?php
...
?>
	...
	<div class="m-input-prepend hide pass top-left-corner top-right-corner bottom-left-corner bottom-right-corner">
		<span class="add-on top-left-corner bottom-left-corner"><?php echo translate_span('password'); ?></span>
		<input class="m-wrap translate top-right-corner bottom-right-corner" size="20" type="password" name="member_profile_password" data-lang-ja="<?php echo $input_interfaces['password']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['password']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['password']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['password']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['password']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['password']['vi']; ?>" placeholder="<?php echo $input_interfaces['password'][$lang_code]; ?>">
	</div>
	<div class="m-input-prepend hide pass top-left-corner top-right-corner bottom-left-corner bottom-right-corner">
		<span class="add-on top-left-corner bottom-left-corner"><?php echo translate_span('repeat_password'); ?></span>
		<input class="m-wrap translate top-right-corner bottom-right-corner" size="20" type="password" name="member_profile_repeat_password" data-lang-ja="<?php echo $input_interfaces['repeat_password']['ja']; ?>" data-lang-zh="<?php echo $input_interfaces['repeat_password']['zh']; ?>" data-lang-es="<?php echo $input_interfaces['repeat_password']['es']; ?>" data-lang-ru="<?php echo $input_interfaces['repeat_password']['ru']; ?>" data-lang-en="<?php echo $input_interfaces['repeat_password']['en']; ?>" data-lang-vi="<?php echo $input_interfaces['repeat_password']['vi']; ?>" placeholder="<?php echo $input_interfaces['repeat_password'][$lang_code]; ?>">
	</div>
	<input class="m-btn translate green top-left-corner top-right-corner bottom-left-corner bottom-right-corner" name="member_profile_submit" type="submit" data-lang-ja="<?php echo $button_interfaces['update']['ja']; ?>" data-lang-zh="<?php echo $button_interfaces['update']['zh']; ?>" data-lang-es="<?php echo $button_interfaces['update']['es']; ?>" data-lang-ru="<?php echo $button_interfaces['update']['ru']; ?>" data-lang-en="<?php echo $button_interfaces['update']['en']; ?>" data-lang-vi="<?php echo $button_interfaces['update']['vi']; ?>" value="<?php echo $button_interfaces['update'][$lang_code]; ?>" />
	<a id="member_logout" class="m-btn blue button_changeable top-left-corner top-right-corner bottom-left-corner bottom-right-corner" href="/triggers/member_logout.php"><i class="icon-log-out icon-white"></i> <?php echo translate_button('logout'); ?></a>
<?php
if (isset($_POST['member_profile_submit'])) {
	if ($member_profile_errors) {
		echo '<span class="error">'.implode('<br />',$member_profile_errors).'</span>';
	} elseif (!count($member_profile_errors)) {
