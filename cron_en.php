...
function get_wiki_url_nsh(string $title): string {
	return 'https://biorhythm.xyz/wiki/'.str_replace(' ', '_', $title);
}
...
function generate_message_id(): string {
	return sprintf("<%s.%s@%s>",base_convert(microtime(), 10, 36),base_convert(bin2hex(openssl_random_pseudo_bytes(8)), 16, 36),"biorhythm.xyz");
}
function send_mail(string $to,string $subject,array $message): void {
	global $span_interfaces, $email_credentials, $brand;
...
//	if (!in_array(strtolower($to), $unsubscriber_emails)) {
		...
		$headers .= "From: \"".$brand."\" <noreply@biorhythm.xyz>".PHP_EOL;
		$headers .= "Sender: <noreply@biorhythm.xyz>".PHP_EOL;
...
function email_message(string $heading,string $content): array {
	$message = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head> <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/> <meta name="viewport" content="width=device-width"/></head><body style="padding: 0px; margin: 0px; width: 100%; min-width: 100%"> <table class="body" style="color: #222222;background-image: url(\'https://biorhythm.xyz/css/images/coin.png\'); min-height: 420px;border: none; border-spacing: 0px; position: relative; height: 100%;width: 100%; top: 0px; left: 0px; margin: 0px;"> <tr style="padding: 0px; margin: 0px;text-align: center; width: 100%;"> <td style="padding: 0px; margin: 0px;text-align: center; width: 100%;" align="center" valign="top"> <center> <table style="height: 100px;padding: 0px;width: 100%;position: relative;background: #007799;" class="row header"> <tr> <td style="text-align: center;" align="center"> <center> <table style="margin: 0 auto;text-align: inherit;width: 95% !important;" class="container"> <tr> <td style="padding: 10px 20px 0px 0px;position: relative;display: block !important;padding-right: 0 !important;" class="wrapper last"> <table style="width: 95%;" class="twelve columns"> <tr> <td style="padding: 8px;" class="six sub-columns"> <a target="_blank" href="https://biorhythm.xyz/"><img alt="logo" src="https://biorhythm.xyz/app-icons/icon-60.png"> </a> </td><td class="six sub-columns last" style="text-align:left; vertical-align:middle;padding-right: 0px; color: white; width: 90%"> <span class="template-label"><a style="font-size: 24px;color: white; text-decoration: none;" target="_blank" href="https://biorhythm.xyz/">'.$heading.'</a></span> </td><td class="expander"></td></tr></table> </td></tr></table> </center> </td></tr></table> <table class="container"> <tr> <td> <table class="row"> <tr> <td style="padding: 10px 10px 0px 0px;position: relative;display: block !important;padding-right: 0 !important;" class="wrapper last"> <table style="width: 80%;font-size:16px;margin: auto;" class="twelve columns"> <tr> <td> '.$content.' </td><td class="expander"></td></tr></table> </td></tr></table> </td></tr></table> </center> </td></tr></table></body></html>';
	return array(
		'html' => $message,
...
//	$feed_email = rss_feed_email('https://biorhythm.xyz/blog/feed/?cat=3%2C81',$span_interfaces['latest_posts']['vi'],'feed_blog');
	for ($i = 0; $i < $count; ++$i) {
		...
		$content = "";
		$content .= (has_birthday($members[$i]['dob'], time())) ? '<style>body {background-image: url("https://biorhythm.xyz/css/images/gifts_mobile.png") !important;}</style>' : "";
...
//		$content .= '<a href="https://bitminer.io/2537977" target="_blank"><img src="https://bitminer.io/s/bitminer_4.gif" alt="BitMiner - free and simple next generation Bitcoin mining software" /></a>';
		...
		$content .= '<p><a href="https://biorhythm.xyz/member/'.$members[$i]['email'].'/">'.$email_interfaces['go_to_your_profile'][$members[$i]['lang']].'</a></p>';
...
//			$content .= $feed_email;
		...
		$content .= '<h4><a href="https://biorhythm.xyz/donate/?lang='.$members[$i]['lang'].'">'.$span_interfaces['donate'][$members[$i]['lang']].'</a> '.$span_interfaces['donate_reason'][$members[$i]['lang']].'</h4>';
...
//		$content .= '<form method="POST" action="https://biorhythm.xyz/unsubscribe/"><input type="hidden" name="email" value="'.$members[$i]['email'].'" /><input type="submit" name="unsubscribe_submit" value="'.$email_interfaces['unsubscribe'][$members[$i]['lang']].'" /></form>';
		$content .= '<a href="https://biorhythm.xyz/unsubscribe/?email='.$members[$i]['email'].'&token='.hash_token($members[$i]['email']).'">'.$email_interfaces['unsubscribe'][$members[$i]['lang']].'</a>';
