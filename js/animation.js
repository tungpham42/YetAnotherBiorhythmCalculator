        ...
        $(document).ready(function() {
            if (Modernizr.mq(mqGenie.adjustMediaQuery('all and (min-width: 420px) and (max-width: 591px)'))) {
                if ($(document).scrollTop() <= 33) {
                    $('#proverb').css('top', (-105 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0)) + 'px')
                } else if ($(document).scrollTop() > 33 && $(document).scrollTop() <= ($('#results').height() + ($('#avatar').outerHeight(!0) || 0) + ($('#profile_form').outerHeight(!0) || 0) - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height() + 143)) {
                    $('#proverb').css('top', ($(document).scrollTop() - 141 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0) - ($('#top_banner').outerHeight(!0) || 0)) + 'px')
                } else {
                    $('#proverb').css('top', ($('#results').height() - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height()) + 'px')
                }
            } else if (Modernizr.mq(mqGenie.adjustMediaQuery('all and (max-width: 959px)'))) {
                if ($(document).scrollTop() <= 100) {
                    $('#proverb').css('top', (0 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0)) + 'px')
                } else if ($(document).scrollTop() > 100 && $(document).scrollTop() <= ($('#results').height() + ($('#avatar').outerHeight(!0) || 0) + ($('#profile_form').outerHeight(!0) || 0) - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height() + 100)) {
                    $('#proverb').css('top', ($(document).scrollTop() - 100 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0) - ($('#top_banner').outerHeight(!0) || 0)) + 'px')
                } else {
                    $('#proverb').css('top', ($('#results').height() - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height()) + 'px')
                }
            } else if (Modernizr.mq(mqGenie.adjustMediaQuery('all and (min-width: 960px)'))) {
                if ($(document).scrollTop() <= 115) {
                    $('#proverb').css('top', (13 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0)) + 'px')
                } else if ($(document).scrollTop() > 115 && $(document).scrollTop() <= ($('#results').height() + ($('#avatar').outerHeight(!0) || 0) + ($('#profile_form').outerHeight(!0) || 0) - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height() + 115)) {
                    $('#proverb').css('top', ($(document).scrollTop() - 102 - ($('#avatar').outerHeight(!0) || 0) - ($('#profile_form').outerHeight(!0) || 0) - ($('#top_banner').outerHeight(!0) || 0)) + 'px')
                } else {
                    $('#proverb').css('top', ($('#results').height() - $('#main_chart').height() + ($('#clock').outerHeight(!0) || 0) + ($('#help').outerHeight(!0) || 0) + ($('#sleep_time').outerHeight(!0) || 0) + ($('#ad_feed').outerHeight(!0) || 0) + ($('#link_ads').outerHeight(!0) || 0) + ($('#news').outerHeight(!0) || 0) - $('#proverb').height()) + 'px')
                }
            }
