...
function getWuXing(date) {
	...
	var stem = lunarValues[0];
	var branch = lunarValues[1];
	var year = stem+' '+branch;
	switch (year) {
		case 'Giáp Tý': return 'Hải Trung Kim'; break;
		case 'Ất Sửu': return 'Hải Trung Kim'; break;
		case 'Bính Dần': return 'Lư Trung Hỏa'; break;
		case 'Đinh Mão': return 'Lư Trung Hỏa'; break;
		case 'Mậu Thìn': return 'Đại Lâm Mộc'; break;
		case 'Kỷ Tỵ': return 'Đại Lâm Mộc'; break;
		case 'Canh Ngọ': return 'Lộ Bàng Thổ'; break;
		case 'Tân Mùi': return 'Lộ Bàng Thổ'; break;
		case 'Nhâm Thân': return 'Kiếm Phong Kim'; break;
		case 'Quý Dậu': return 'Kiếm Phong Kim'; break;
		case 'Giáp Tuất': return 'Sơn Đầu Hỏa'; break;
		case 'Ất Hợi': return 'Sơn Đầu Hỏa'; break;
		case 'Bính Tý': return 'Giản Hạ Thủy'; break;
		case 'Đinh Sửu': return 'Giản Hạ Thủy'; break;
		case 'Mậu Dần': return 'Thành Đầu Thổ'; break;
		case 'Kỷ Mão': return 'Thành Đầu Thổ'; break;
		case 'Canh Thìn': return 'Bạch Lạp Kim'; break;
		case 'Tân Tỵ': return 'Bạch Lạp Kim'; break;
		case 'Nhâm Ngọ': return 'Dương Liễu Mộc'; break;
		case 'Quý Mùi': return 'Dương Liễu Mộc'; break;
		case 'Giáp Thân': return 'Tuyền Trung Thủy'; break;
		case 'Ất Dậu': return 'Tuyền Trung Thủy'; break;
		case 'Bính Tuất': return 'Ốc Thượng Thổ'; break;
		case 'Đinh Hợi': return 'Ốc Thượng Thổ'; break;
		case 'Mậu Tý': return 'Thích Lịch Hỏa'; break;
		case 'Kỷ Sửu': return 'Thích Lịch Hỏa'; break;
		case 'Canh Dần': return 'Tùng Bách Mộc'; break;
		case 'Tân Mão': return 'Tùng Bách Mộc'; break;
		case 'Nhâm Thìn': return 'Trường Lưu Thủy'; break;
		case 'Quý Tỵ': return 'Trường Lưu Thủy'; break;
		case 'Giáp Ngọ': return 'Sa Trung Kim'; break;
		case 'Ất Mùi': return 'Sa Trung Kim'; break;
		case 'Bính Thân': return 'Sơn Hạ Hỏa'; break;
		case 'Đinh Dậu': return 'Sơn Hạ Hỏa'; break;
		case 'Mậu Tuất': return 'Bình Địa Mộc'; break;
		case 'Kỷ Hợi': return 'Bình Địa Mộc'; break;
		case 'Canh Tý': return 'Bích Thượng Thổ'; break;
		case 'Tân Sửu': return 'Bích Thượng Thổ'; break;
		case 'Nhâm Dần': return 'Kim Bạch Kim'; break;
		case 'Quý Mão': return 'Kim Bạch Kim'; break;
		case 'Giáp Thìn': return 'Phú Đăng Hỏa'; break;
		case 'Ất Tỵ': return 'Phú Đăng Hỏa'; break;
		case 'Bính Ngọ': return 'Thiên Hà Thủy'; break;
		case 'Đinh Mùi': return 'Thiên Hà Thủy'; break;
		case 'Mậu Thân': return 'Đại Trạch Thổ'; break;
		case 'Kỷ Dậu': return 'Đại Trạch Thổ'; break;
		case 'Canh Tuất': return 'Thoa Xuyến Kim'; break;
		case 'Tân Hợi': return 'Thoa Xuyến Kim'; break;
		case 'Nhâm Tý': return 'Tang Đố Mộc'; break;
		case 'Quý Sửu': return 'Tang Đố Mộc'; break;
		case 'Giáp Dần': return 'Đại Khe Thủy'; break;
		case 'Ất Mão': return 'Đại Khe Thủy'; break;
		case 'Bính Thìn': return 'Sa Trung Thổ'; break;
		case 'Đinh Tỵ': return 'Sa Trung Thổ'; break;
		case 'Mậu Ngọ': return 'Thiên Thượng Hỏa'; break;
		case 'Kỷ Mùi': return 'Thiên Thượng Hỏa'; break;
		case 'Canh Thân': return 'Thạch Lựu Mộc'; break;
		case 'Tân Dậu': return 'Thạch Lựu Mộc'; break;
		case 'Nhâm Tuất': return 'Đại Hải Thủy'; break;
		case 'Quý Hợi': return 'Đại Hải Thủy'; break;
	}
}
...
lunarApp.controller('lunarController', ['$scope', function($scope) {
	...
	$scope.wuXing = function(){
		if (isset($scope.solarDate) && !isEmpty('#solarDate')){
			return getWuXing($scope.solarDate);
		}
	}
